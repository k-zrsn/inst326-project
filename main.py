...
#Table 
table = ttk.Treeview(window, columns = ('Name', 'Phone', 'Email', 'Pay Rate', 'Assigned Hours', 'Weekly Total', 'Monthly Total'), show = 'headings')
table.heading('Name', text = 'Caregiver Name')
table.heading('Phone', text = 'Caregiver Phone Number')
table.heading('Email', text = 'Caregiver Email')
table.heading('Pay Rate', text = 'Caregiver Hourly Pay')
table.heading('Assigned Hours', text = 'Caregiver Weekly Hours')
table.heading('Weekly Total', text = 'Caregiver Weekly Pay')
table.heading('Monthly Total', text = 'Caregiver Monthly Pay')
